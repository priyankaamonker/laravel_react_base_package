...
/**
* @see \App\Http\Controllers\UserController::verifyEmail
* @see app/Http/Controllers/UserController.php:158
* @route '/users/{user}/verify-email'
*/
export const verifyEmail = (args: { user: number | { id: number } } | [user: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
...
* @route '/users/{user}/verify-email'
*/
verifyEmail.url = (args: { user: number | { id: number } } | [user: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { user: args }
    }
...
* @route '/users/{user}/verify-email'
*/
verifyEmail.post = (args: { user: number | { id: number } } | [user: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: verifyEmail.url(args, options),
    method: 'post',
})
...
* @route '/users/{user}/verify-email'
*/
const verifyEmailForm = (args: { user: number | { id: number } } | [user: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/users/{user}/verify-email'
*/
verifyEmailForm.post = (args: { user: number | { id: number } } | [user: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: verifyEmail.url(args, options),
    method: 'post',
})
