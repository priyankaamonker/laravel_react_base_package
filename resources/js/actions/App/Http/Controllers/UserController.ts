...
/**
* @see \App\Http\Controllers\UserController::sendVerificationEmail
* @see app/Http/Controllers/UserController.php:158
* @route '/users/{user}/verify-email'
*/
export const sendVerificationEmail = (args: { user: number | { id: number } } | [user: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: sendVerificationEmail.url(args, options),
    method: 'post',
})

sendVerificationEmail.definition = {
    methods: ["post"],
    url: '/users/{user}/verify-email',
} satisfies RouteDefinition<["post"]>
...
* @route '/users/{user}/verify-email'
*/
sendVerificationEmail.url = (args: { user: number | { id: number } } | [user: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { user: args }
    }
    ...
    return sendVerificationEmail.definition.url
            .replace('{user}', parsedArgs.user.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
...
* @route '/users/{user}/verify-email'
*/
sendVerificationEmail.post = (args: { user: number | { id: number } } | [user: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: sendVerificationEmail.url(args, options),
    method: 'post',
})
...
* @route '/users/{user}/verify-email'
*/
const sendVerificationEmailForm = (args: { user: number | { id: number } } | [user: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: sendVerificationEmail.url(args, options),
    method: 'post',
})
...
* @route '/users/{user}/verify-email'
*/
sendVerificationEmailForm.post = (args: { user: number | { id: number } } | [user: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: sendVerificationEmail.url(args, options),
    method: 'post',
})
...
const UserController = { index, create, store, show, edit, update, destroy, sendVerificationEmail }
